...
public class Condition03 {
    public static void main(String[] args) {
        /*
            ...
            조건식 : 참(true) 도는 거짓(false)을 평가할 수 있는 식
            실행문1 : 조건식에 true일 경우 실행되는 식
            실행문2 : 조건식에 false일 경우 실행되는 식
         */
...
//        System.out.println("더 큰 수는 " + max + "입니다.");
        ...
        /*
            일반적인 조건문을 삼합연산자로 변형시키기 위한 조건
            1. if - else 구문으로 이루어질 것
...
//        2) if else 구조 예제
        ...
        String examleSentence = "";
//        if(num >= 0) {
//            System.out.println("num은 양수이거나 0입니다.");
//        } else {        // else는 if가 false일 때 실행되는 최종 조건문이므로 조건식이
//                        // 포함되지 않음 -> num이 0 미만일 경우 // num < 0
//            System.out.println("num은 음수입니다.");
//        }
        // 이상의 if - else 구문을 3항 연산자로 바꾸시오.
        examleSentence = num >= 0 ? "num은 양수이거나 0입니다." : "num은 음수입니다."; // 삼항연산자 조건식 시작
        System.out.println(examleSentence);
    }
}
