...
//        item1.setStock(10);         // 오류 발생
        ...
        // 부모 크래스의 객체는 자식 클래스의 필드및 메서드를 사용할 수 없음.
        //실행 예
        // 이 상품은 일반 상품입니다.
        // 이 상품은 일반 카테고리입니다.    -> getter를 활용화여 해당 출력문이 콜솔에 나오도록
...
//        System.out.println("이 상품은 " + item1.getCategory() + "입니다.");
        ...
        // Product 객체를 생성하세요.
        // 객체 제품, 기존, 100000, 10로 생성하고, displayInfo()를 통해서 콘솔에 정보를 출력하세요.

        // product의 이름을 "가진 이름"으로 바꾸고, getName을 통해 바뀐 것을 콘솔창에 출력하시오.
    }
}
