...
/*
    ...
    제네릭의 개념 및 정의
        제네릭은 클래스나 메서드가 다른 데이터 타입을 미리 명시하여 재사용성과 유연성을 높이는 기술
        ...
        타입 매개변수(Type Parameter) : 클래스나 메서드에서 사용할 실제 타입을 "대신하여" 사용하는 매개변수
            ...
            2. E(Element) : 켈렉션의 요소를 나타낼 때 사용
            3. K(Key) : 임의 Key를 나타낼 때 사용 -> 아직 수업 안했습니다.
            4. V(Value) : 임의 값(Value) 또는 제네릭 타입의 반환값으로 사용 -> 아직 수업 안했습니다.

            재사용성 : 제네릭을 사용하면 다양한 데이터 타입에 대해 하나의 클래스나 메서드를 정의할 수 있어
                코드의 재사용성을 높이고 중복을 줄입니다.

            타입 안정성(Type Safety) : 컴파일 시점에 타입 체크를 할 수 있어 프로그램의 안전성을 높이고,
                명시적인 형변환을 줄임.

            다 끝나신 분들은
            Products.java
            ProductsMain.java -> 여기는 main 적용 파일 만드세요
 */
public class DataController {
    public static void main(String[] args) {
        ...
        // Data 클래스의 객체인 now의 객체에 딸려있는 인스턴스 메서드 toString()
        // ResponseData 클래스를 확인해보려면 T data로 정의한 필드가 있는데, 이를
        ...
        // ResponseData 클래스에 @Data로 입력했기 때문에 @ToString이 포함돼 있습니다.
