...
public class Person {
    ...
    // 기본생성자, 매개변수 생성자를 전부 만들어보세요.
    // PersonMain.java에서 해당 객체들을 만드세요.
    // Person person1 = new Person();
    // Person person1 = new Person("이하온");
    // Person person1 = new Person(-100);
    // Person person1 = new Person("사실 나는 사람이 아니다", 1000);
    ...
    // 2. Setter의 구조
    //      메서드에 매개변수가 필수적을 요구됨 -> 값을 변경하거나 대입할 argument가 필요하기 때문
    ...
    // 3. Getter의 구조
    //      메서드를 조회만 하면 되기 때문에 매개변수가 요구되지 않음. 즉 () 형태로 마무리됨.
    ...
    // person4의 name을 이하순, age를 30으로 변경한 후, 바뀐 필드들만 콘솔에 출력하시오.
    public void setAge(int age) {
        // method이기 때문에 {} 내부에 코드를 작성할 수 있음.
        // -> 이를 통해 데이터 유효성 검증을 위한 부분을 추가할 수 있음.
        // 조건문을 작용을 해서 0 이상의 값만 입력이 가능하게끔 코드를 작성하면 됩니다.
        // 시작하세요
        // 다 하신 분들은 150 미만의 값만 입력되게끔 코드를 추가해주세요.
//        if (age <= 0 || age > 150) {
//            System.out.println("150미만 양수만 가능");
//        } else {
//            this.age = age;
//        }
//        if (age >= 0) {
...
//    }
        ...
        // -> 여기에 while문을 붙여서 올바른 값만 입력하게끔 코드를 작성학세요.
...
//        age >= 0 && age < 150 범위의 반대는 어떻게 될까? -> 값이 잘못됐을 때
        ...
        while (age < 0 || age >= 150) {
            System.out.print("나이는 0 이상 150 미만이여야만 합니다. 다시 입력하세요 >>> ");
