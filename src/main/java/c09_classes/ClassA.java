...
/*
    1. 클래스란?
        클래스는 객체를 생성하기 위한 설계도 = 를 / 창사진이라고 볼 수 있음. 현실 세계와
        개발을 프로그래밍으로 표현할 때, "특정 사물이나 개념의 특징(속성)"과 "행동(메서드)"로
        정의함.
        예를 들어,
    ...
    2. 객체(Object)란?
        ...
        여기서 Object라는 표현과 Instance라느 표현은 한국에서는 거의 동일함.
