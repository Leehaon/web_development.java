...
public class ScoreCalculatorMain {
    public static void main(String[] args) {
        ...
        // ScoreCalculator을 import -> 클래스명 객체명 = new 클래스명();    -> constructor
        ScoreCalculator scoreCalculator = new ScoreCalculator();    // 같은 패키지 내에서는 import문이 뜨지 않음.
        int totalSubjects = 0;
        double score1 = 0;
        double score2;
...
//        System.out.print("첫 번째 과목의 정수를 입력하세요 >>> ");
//        score1 = scanner.nextDouble();
//        System.out.print("두 번째 과목의 정수를 입력하세요 >>> ");
//        score2 = scanner.nextDouble();
//        System.out.print("세 번째 과목의 정수를 입력하세요 >>> ");
//        double score3 = scanner.nextDouble();
//
//        // 기본 연산자를 활용한 방법
//        System.out.println("총합은 " + (score1 + score2 + score3) + "점 입니다.");
...
//        System.out.println("-----------------------------------");
//        System.out.println("총합은 " + (score1 + score2 + score3) + "점 입니다.(메서드 활용)");
//        System.out.println("평균 점수는 " + avgScore + "점 입니다.(메서드 활용)");

        // 2. 점수를 누직적으로 더할 수 있게끔 자성하는 방식의 프로그램
...
//                -> 다음 반복문이 실행될 때 boolean 연산자의 true/false르 검증하기 때문에 그 전까지는 그대로 실행됨
            }
...
//            System.out.println("총 점은 " + totalScore + "점입니다.\n현재 과목의 수는 " + totalSubjects + "개 입니다.");
            ...
            } else {        // totalSubject <= 0인 경우
                System.out.println("입력된 점수가 없습니다.");
            }
        }

        // 분모가 0이면 예외가 발생하기 때문에, totlalSubect가 0초과일 때만 실행되도록 조건문 설정 -> 예외처리의 고전적방법
//        System.out.println("---------- 최종으로 한 번만 나오는 합계와 평균입니다 ----------");
//        if (totalSubjects > 0) {
//            avgScore = scoreCalculator.calculateAvg(totalScore, totalSubjects);
//            System.out.println("입력된 점수의 합계 : " + totalScore + "\n입력한 점수의 평균 : " + avgScore);
