...
public class ProductMain {
        ...
        // 여기에 나오지는 않지만 getter와 setter가 정의되었습니다 -> 이것은 main 메서드 영역 내에서 객체 생성 및
    ...
    public static void main(String[] args) {
        ...
        // 클래스명 객체명 = new 클래스명();   -> 여기서 부터는 Product가 객체가 아니라 ProductMain의 객체입니다.
        ProductMain productMain1 = new ProductMain();
        /*
            productMain1의 name에 "pm1"을 set하고, 콘솔명에 pm1이 나오도록 getter를 이용하세요.
         */
