...
public class Samsung {
    ...
    // 여기서부터 싱글톤 패턴을 작성합니다.
    // 1. 스테틱 변수 정의             -> 보통 실글톤 만들 때 객체명을 instance로 쓰는 편
    ...
    public static Samsung getInstance() {
        ...
        // 만약에 이상의 조건문이 생성되지 않는다면 이미 instance가 있다는 의미
        // 즉 getInstance() 메서드는 실현되기만 하면 어쨌든 Samsung 클래스의 객체가
        // return 된다는 점을 확인할 우 있습니다.
        return instance;
    }
    public String scoreSerialNumber(String model) {
